...
<div class="py-12">
    <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
        <div class="bg-red overflow-hidden shadow-xl sm:rounded-lg p-5">
            ...
            <form method="POST" action="/task">
                ...
                <div class="form-group">
                    <button type="submit" class="bg-blue-500 hover:bg-blue-700 text font-bold py-2 px-4 rounded">Add Task jaa</button>
                </div>
                {{ csrf_field() }}
            </form>
        </div>
