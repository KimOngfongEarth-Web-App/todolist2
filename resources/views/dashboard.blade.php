...
<div class="py-12" >
    ...
    <div class="max-w-5xl mx-auto sm:px-6 lg:px-8" >
        ...
        <div class=" overflow-hidden shadow-xl sm:rounded-lg p-5 bg-yellow-ja bg-opacity-50" >
            ...
            <div class="fb-share-button" data-href="http://127.0.0.1:8000/dashboard" data-layout="button" data-size="small"><a target="_blank" href="https://www.facebook.com/sharer/sharer.php?u=http%3A%2F%2F127.0.0.1%3A8000%2Fdashboard&amp;src=sdkpreparse" class="fb-xfbml-parse-ignore"></a></div>
